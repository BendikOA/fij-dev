...
const Forfattere = () => {
  return (
    ...
    <div className="flex flex-col md:h-auto md:flex-row justify-center  mx-[1.25rem] md:mx-[3.75rem] lg:mx-[9.3rem] jlg:mx-[23.6rem] pt-[18.75rem]  pb-12">
        ...
        <div class="md:w-1/2   order-2 md:order-1 ">
            ...
            <img className=' mx-auto md:mx-0 w-[131px] ' src='./erik.png' alt=""
                    />
                <h1 className='text-[30px] md:text-[40px] font-youngs pt-8 '>Erik Joner</h1>
        ...
        <div class="md:w-1/2 md:ml-[2rem] jlg:ml-[4.3rem] order-2 md:order-1 ">
            <div className='text-hvit'>
            <img className=' mx-auto md:mx-0 w-[131px] ' src='./arne.png' alt=""
                    />
                <h1 className='text-[30px] md:text-[40px] font-youngs pt-8 '>Arne Grønlund</h1>
                <div className='md:max-w-sm leading-5'>
                <p className='text-[16px] lg:text-[17px] mt-[25px] md:mt-[30px] max-w-[342px]'>
