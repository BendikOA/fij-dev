                ...
                <div className="md:w-1/2  pt-8 md:pl-12 md:pt-10 lg:pt-0 lg:pl-6 xl:pl-0 flex flex-start md:justify-start">
                    <div className=' text-hvit '>
                        <div className='leading-5'>
                            <img className=' mx-auto md:mx-0 w-[60%] md:w-[80%] jlg:w-[60%] ' src='../boka2.webp' alt="3D-render av boka Finger'n i jorda. I et skandinavisk skog-landskap, står boka oppstilt på bakken foran en liggende trestamme."
                            />
