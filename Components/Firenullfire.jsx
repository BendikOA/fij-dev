  ...
  return (
    <div className='w-full min-h-screen'>
      <div className='mx-[1.25rem] md:mx-[3.75rem] lg:mx-[9.3rem] pt-[4.1rem] md:pt-[11.3rem] lg:pt-[16rem] jlg:pt-[18.75rem] py-auto'>
        ...
        <div className='justify-center  place-items-center  grid md:grid-flow-col md: gap-36 lg:gap-48 xl:gap-96'>
          ...
          <div>
            <div className='pb-24 md:py-24 '>
              <ul className='text-center md:text-right text-[1.25rem] text-hvit font-youngs '>
