...
const Holding = () => {
  return (
    <section className='bg-brun h-screen '>
      <div className="flex flex-col justify-center h-full lg:mx-[150px]">
        <div className='items-center lg:max-w-[35%] mx-auto'>
          <h1 className=' text-hvit text-[40px] font-youngs '>Finger'n i jorda</h1>
          <div className='flex flex-col text-hvit'>
            <p className='text-[17px] mt-8 font-btext' >
