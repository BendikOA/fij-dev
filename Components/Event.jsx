    ...
    return (
        <div className='w-full'>
            <div className="flex flex-col md:h-auto md:flex-row justify-center  mx-[1.25rem] md:mx-[3.75rem] lg:mx-[9.3rem] pb-12 font-sans">
                <div className=' md:w-1/2 lgl:ml-[8.3rem] jlg:ml-[8.3rem] pt-12 md:pt-0  md:bg-brun xl:bg-transparent'>
                    <div className='text-hvit'>
                        ...
                        <h1 className='text-[1.6rem] xxl:text-4xl xxl:pt-4 md:mt-32 font-youngs pt-12'>Innholdsfortegnelse</h1>
